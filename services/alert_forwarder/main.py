...
async def send_to_openremote(payload):
    try:
        ...
        print(f"[alert_forwarder] WS error: {e}")

def on_message(client, userdata, msg):
    if "alert" in msg.topic or "alarm" in msg.topic:
        payload = {"type": "alert", "topic": msg.topic, "data": msg.payload.decode()}
...
def main():
    ...
    client.subscribe("#")
    print("[alert_forwarder] Connected to MQTT.")
    client.loop_forever()
